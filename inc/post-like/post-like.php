...
function sl_enqueue_scripts(){
	wp_localize_script('ecko_js', 'simpleLikes', array(
		'ajaxurl' => admin_url( 'admin-ajax.php'),
		'like' => __('Like', 'hicorp'),
		'unlike' => __('Unlike', 'hicorp')
	));
}
...
function show_user_likes( $user ) { ?>
	<table class="form-table">
		<tr>
			<th><label for="user_likes"><?php _e( 'You Like:', 'hicorp' ); ?></label></th>
			<td>
			<?php
			...
			<?php else : ?>
			<p><?php _e( 'You do not like anything yet.', 'hicorp' ); ?></p>
			<?php
			endif;
			wp_reset_postdata();
			?>
